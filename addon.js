...
const manifest = {
    ...
    description: 'HDFilmCehennemi üzerinden Türkçe dublaj ve altyazılı film/dizi izleyin.',
    types: ['movie', 'series'],
    idPrefixes: ['tt'],
    ...
    logo: 'https://www.hdfilmcehennemi.ws/assets/img/logo.png',
    background: 'https://www.hdfilmcehennemi.ws/assets/img/bg.jpg',
    behaviorHints: {
        configurable: true,
...
/**
 * Catalog handler - Proxy to Cinemeta
 */
...
app.get('/health', (req, res) => {
    ...
    res.json({
        status: 'ok',
        addon: true,
        decoderProfile: profile ? 'ok' : 'legacy',
        lastDecoderCheck: profile ? profile.detectedAt : null
    });
});
